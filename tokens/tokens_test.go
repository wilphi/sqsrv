...
func TestTokenize(t *testing.T) {
	data := []TokenData{
		...
		},
		{
			...
			testStr:  "AND ASC AVG BOOL BY COUNT CREATE DELETE DESC DISTINCT DROP FALSE FLOAT FROM GROUP HAVING INSERT INT INTO MAX MIN NOT NULL OR ORDER SELECT SET STRING SUM TABLE TRUE UPDATE VALUES WHERE\n",
